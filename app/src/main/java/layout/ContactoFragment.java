...
public class ContactoFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng hcmus = new LatLng(40.4931236, -3.3633425000000443);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(hcmus, 18));
        originMarkers.add(
                mMap.addMarker(new MarkerOptions()
                        .title("Clínica Veterinaria Alcarria")
                        .position(hcmus)));
...
/*
    ...
    public void onDirectionFinderSuccess(List<Route> routes) {
        ...
        for (Route route : routes) {
            ...
            //txv_calculo.setText("Duracion: " + route.duration.text + " Distancia: " + route.distance.text);
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mTrackView = inflater
                .inflate(R.layout.fragment_contacto, container, false);
        ...
        return mTrackView;//inflater.inflate(R.layout.fragment_contacto, container, false);
    }
